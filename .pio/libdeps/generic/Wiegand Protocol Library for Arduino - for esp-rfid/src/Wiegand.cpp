...
bool WIEGAND::DoWiegandConversion ()
{
	...
	{
		if ((_bitCount==24) || (_bitCount==26) || (_bitCount==32) || (_bitCount==34) || (_bitCount==37) || (_bitCount==44) || (_bitCount==56) || (_bitCount==58) || (_bitCount==8) || (_bitCount==4)) 	// bitCount for keypress=4 or 8, Wiegand 26=24 or 26, Wiegand 34=32 or 34
		{
